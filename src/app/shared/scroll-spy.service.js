...
export class ScrollSpiedElementGroup {
    ...
    constructor(elements) {
        this.activeScrollItem = new ReplaySubject(1);
...
export class ScrollSpyService {
    constructor(doc, scrollService) {
        ...
        this.onStopListening = new Subject();
        this.resizeEvents = fromEvent(window, 'resize').pipe(auditTime(300), takeUntil(this.onStopListening));
...
ScrollSpyService.ɵfac = function ScrollSpyService_Factory(t) { return new (t || ScrollSpyService)(i0.ɵɵinject(DOCUMENT), i0.ɵɵinject(i1.ScrollService)); };
ScrollSpyService.ɵprov = i0.ɵɵdefineInjectable({ token: ScrollSpyService, factory: ScrollSpyService.ɵfac });
/*@__PURE__*/ (function () { i0.ɵsetClassMetadata(ScrollSpyService, [{
        type: Injectable
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: i1.ScrollService }]; }, null); })();
//# sourceMappingURL=scroll-spy.service.js.map